...
<html xmlns:v="urn:schemas-microsoft-com:vml"
    ...
    <head>
        ...
        <title> SEGIA - Lista de Presenças</title>
        ...
        <div class=WordSection1>
            ...
            <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=765
                ...
                <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:26.9pt'>
                    ...
                    <td width=117 nowrap style='width:87.75pt;border:solid windowtext 1.0pt;
                        border-left:none;padding:0cm 5.4pt 0cm 5.4pt;height:26.9pt'>
                        <p class=MsoNormal align=center style='text-align:center'><b><span
                                    style='font-size:8.0pt;line-height:105%;font-family:Poppins'>Nº Doc.
                                    Identificação</span></b></p>
                    </td>
                    <td width=119 nowrap style='width:89.45pt;border:solid windowtext 1.0pt;
                        border-left:none;padding:0cm 5.4pt 0cm 5.4pt;height:26.9pt'>
                        <p class=MsoNormal align=center style='text-align:center'><b><span
                                    style='font-size:8.0pt;line-height:105%;font-family:Poppins'>Ass. do
                                    Candidato</span></b></p>
                    </td>
                    <td width=94 nowrap style='width:70.85pt;border:solid windowtext 1.0pt;
                        border-left:none;padding:0cm 5.4pt 0cm 5.4pt;height:26.9pt'>
                        <p class=MsoNormal align=center style='text-align:center'><b><span
                                    style='font-size:8.0pt;line-height:105%;font-family:Poppins'>Observações</span></b></p>
                    </td>
                </tr>
                ...
                <tr style='mso-yfti-irow:1;height:.35pt'>
                    ...
                    <td width=117 nowrap style='width:87.75pt;border-top:none;border-left:none;
                        border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                        padding:0cm 5.4pt 0cm 5.4pt;height:.35pt'>
                        <p class=MsoNormal style='text-align:justify'><span style='font-size:7.0pt;
                                                                            line-height:105%;font-family:Poppins'><%=bi%></span></p>
                    </td>
                    <td width=119 nowrap style='width:89.45pt;border-top:none;border-left:none;
                        border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                        padding:0cm 5.4pt 0cm 5.4pt;height:.35pt'>
                        <p class=MsoNormal style='text-align:justify'><span style='font-size:7.0pt;
                                                                            line-height:105%;font-family:Poppins'>&nbsp;</span></p>
                    </td>
            ...
            <table class="table table-bordered" style="width: 100%; text-align:center;">
                <tbody>
                    <tr>
                        <td><b style='font-size:8.0pt;font-family:Poppins'><br><br>1º Vigilante: _____________________ </b></td>
                        <td><b style='font-size:8.0pt;font-family:Poppins'><br><br>2º Vigilante: _____________________ </b></td>
                    </tr>
                    <tr>
                        <td><b style='font-size:8.0pt;font-family:Poppins'><%=decJ1%></b></td>
                        <td><b style='font-size:8.0pt;font-family:Poppins'><%=decJ2%></b></td>
                    </tr>
                </tbody>
            </table>
