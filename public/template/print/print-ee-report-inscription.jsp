...
<%@page import="com.dciapps.local.EEReport1"%>
...
<html xmlns:v="urn:schemas-microsoft-com:vml"
    ...
    <head>
        ...
        <title> SEGIA - Número de Candidatos Inscritos</title>
        ...
        <%
            ...
            List<EEReport1> eReport1s = (List<EEReport1>) session.getAttribute("eReport1s");
                    ...
                    <td width=601 valign=top style='width:450.8pt;border:solid windowtext 1.0pt;
                        ...
                        <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center;
                           line-height:normal'><b><span style='font-size:8.0pt;font-family:Poppins;
                                   color:black'>NÚMERO DE CANDIDATOS INSCRITOS POR CENTRO - ANO LECTIVO <%=an%></span></b></p>
                    </td>
                </tr>
            </table>
            ...
            <table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
                ...
                <tr style='height:30.65pt'>
                    ...
                    <td width=102 rowspan=2 style='width:76.8pt;border:solid windowtext 1.0pt;
                        ...
                        <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center;
                           line-height:normal'><b><span style='font-size:8.0pt;font-family:Poppins;
                                   color:white'>PROVÍNCIA</span></b></p>
                    </td>
                    <td width=124 rowspan=2 style='width:93.3pt;border:solid windowtext 1.0pt;
                        border-left:none;background:#323E4F;padding:0cm 5.4pt 0cm 5.4pt;height:30.65pt'>
                        <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center;
                           line-height:normal'><b><span style='font-size:8.0pt;font-family:Poppins;
                                   color:white'>CENTRO EXAME</span></b></p>
                    </td>
                ...
                <%
                    ...
                    if (eReport1s != null) {
                        ...
                        for (EEReport1 eer : eReport1s) {

                            String s1 = eer.getProvincia();
                            String s2 = eer.getCentro();
                            int n1 = eer.getNumH();
                ...
                <tr style='height:14.9pt'>
                    ...
                    <td width=124 style='width:93.3pt;border-top:none;border-left:none;
                        ...
                        padding:0cm 5.4pt 0cm 5.4pt;height:14.9pt'>
                        <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center;
                           line-height:normal'><span style='font-size:8.0pt;font-family:Poppins'><small><%=s2%></small></span></p>
                    </td>
                    <td width=57 style='width:42.55pt;border-top:none;border-left:none;
                        border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
                        padding:0cm 5.4pt 0cm 5.4pt;height:14.9pt'>
                ...
                %>
                <tr style='height:14.9pt'>
                    <td width=274 colspan=3 style='width:205.3pt;border:solid windowtext 1.0pt;
