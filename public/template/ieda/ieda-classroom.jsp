        ...
        <div class="content-wrapper">
            ...
            <div class="navbar navbar-default navbar-component navbar-xs">
                ...
                <div class="navbar-collapse collapse" id="navbar-filter">
                    <ul class="nav navbar-nav element-active-orange-400">
                        <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-collaboration position-left"></i> Salas de Exame</a></li>
                    </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form method="post" accept-charset="ISO-8859-1" action="SUVEQVNlcnZsZXQjRENJ?YWNjYW8jdHVybWFz">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <%                                String act4 = encryptUtils.encodeString("accao#filtrar-salaExame&to=ee-classroom");
                    %>
                        ...
                        <table class="table datatable-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-bold text-slate text-right">
                                        <%=med%>
                                    </td>
                                </tr>
