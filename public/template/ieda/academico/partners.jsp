                                ...
                                <form method="post" accept-charset="ISO-8859-1" action="UGFyY2Vpcm9TZXJ2bGV0I0RDSQ==?<%=act%>" class="form-horizontal">
                                    ...
                                    <div class="panel panel-flat">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label text-bold text-uppercase">Pessoa de contacto: </label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label text-bold text-uppercase">Endereço: </label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label text-bold text-uppercase">Contacto & Nuit: </label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label text-bold text-uppercase">Área de actuação: </label>
