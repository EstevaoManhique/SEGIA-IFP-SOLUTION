                                                    ...
                                                    <div class="panel panel-flat">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="form-group" hidden="">
                                                                <label class="col-lg-3 control-label text-bold text-uppercase">Tipo: </label>
                                                            ...
                                                            <div class="form-group" hidden>
                                                                <label class="col-lg-3 control-label text-bold text-uppercase">Duração: </label>
                                                            ...
                                                            <div class="form-group" hidden>
                                                                <label class="col-lg-3 control-label text-bold text-uppercase">Prestações: </label>
