                            ...
                            <form method="post" accept-charset="ISO-8859-1" action="UGxhbm9zU2VydmxldCNEQ0k=?<%=act%>" class="form-horizontal">
                                ...
                                <div class="panel panel-flat">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label text-bold text-uppercase">Nº Aulas Teoricas: </label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label text-bold text-uppercase">Nº Aulas Práticas: </label>
