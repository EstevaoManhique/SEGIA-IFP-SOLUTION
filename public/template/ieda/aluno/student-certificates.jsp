...
<html lang="en">
    <head>
        ...
        <title>SEGIA - Certificados do Aluno</title>
                    ...
                    <div class="navbar navbar-default navbar-component navbar-xs">
                        ...
                        <div class="navbar-collapse collapse" id="navbar-filter">
                            <ul class="nav navbar-nav element-active-slate-400">
                                <li class="active"><a href="#settings" data-toggle="tab"  class="text-bold text-uppercase"><i class="icon-certificate position-left"></i> Certificados do Aluno</a></li>
                            </ul>
                        ...
                        <div class="col-md-9 col-md-offset-1">
                            ...
                            <div class="panel panel-flat">
                                <div class="panel-heading">
                                    <h6 class="panel-title text-uppercase text-bold text-bold text-uppercase">Listagem das Inscrições do aluno</h6>
                                    <div class="heading-elements">
                                        <ul class="icons-list">
                                ...
                                <table class="table datatable-responsive">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-bold text-uppercase text-center">---</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="UG9ydGFsU2VydmxldCNEQ0k=?<%=actI%>" target="_blank" data-popup="tooltip" title="Imprimir Certificado"><i class="icon-printer2"></i></a></td>
                                        </tr>
                                        <%
                                                }
                                            }
