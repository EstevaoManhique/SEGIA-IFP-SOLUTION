...
<html lang="en">
    ...
    <head>
        ...
        <title>SEGIA - Marcação de Presenças/Fraudes</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form method="post" accept-charset="ISO-8859-1" action="SUVEQVNlcnZsZXQjRENJ?YWNjYW8jcHJlc2VuY2Fz">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <%                                String act4 = encryptUtils.encodeString("accao#filtrar-salaExame&to=ee-presences");
                    %>
                        ...
                        <form method="post" accept-charset="ISO-8859-1" action="SUVEQVNlcnZsZXQjRENJ?<%=act%>">
                            ...
                            <table class="table datatable-responsive">
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <td><input type="checkbox" name="noty_list" value="<%=idA%>" class="styled" <%=check%>></td>
                                        <td>
                                            <a href="#">
                                                <%=ref%>
                                            </a>
