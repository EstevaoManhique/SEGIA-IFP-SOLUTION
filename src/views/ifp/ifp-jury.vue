                          ...
                          <div class="content-wrapper">
                            ...
                            <div class="navbar navbar-default navbar-component navbar-xs">
                                ...
                                <div class="navbar-collapse collapse" id="navbar-filter">
                                    <ul class="nav navbar-nav element-active-orange-400">
                                        <li class="active"><a href="#settings" data-toggle="tab" class="text-bold text-uppercase"><i class="icon-reading position-left"></i> Criação de Júris Exames (Formação Professores)</a></li>
                                    </ul>
                            ...
                            <div class = "row">
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <form method="post" accept-charset="ISO-8859-1" action="SUZQU2VydmxldCNEQ0k=?YWNjYW8janVyaXM=">
                                        ...
                                        <div class="panel panel-flat">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="select" name="idDocente1" required="" id ="idDocente1">
                                                        <optgroup label="Selecione uma docente">
                                                            ...
                                                            -->
                                                            <option value="0">OUTROS JÚRIS</option>
                                                        </optgroup>
                                                    </select>
        
                                                    <div class="form-group" hidden="" id="juri1">
                                                        <br>
                                                        <label class="text-bold text-uppercase">Nome do Júri 1:</label>
                                                        <input type="text" class="form-control" placeholder="Nome do Juri ..." name="juri1">
                                                    </div>  
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="select" name="idDocente2" required="" id ="idDocente2">
                                                        <optgroup label="Selecione uma docente">
                                                            <!--
                                                                if (docentes != null) {
                                                    ...
                                                    <div class="form-group" hidden="" id="juri2">
                                                        <br>
                                                        <label class="text-bold text-uppercase">Nome do Júri 2:</label>
                                                        <input type="text" class="form-control" placeholder="Nome do Juri ..." name="juri2">
                                                    </div>  
                                                </div>
                                                    ...
                                                    <!--
                                                        if (salasExame != null) {
                                                            for (SalaExame se : salasExame) {
                                                                ...
                                                                if (se.getJuri1() != null) {
                                                                    j1 = encryptUtils.decodeString(se.getJuri1().getPessoa().getPessNome()) + " " + encryptUtils.decodeString(se.getJuri1().getPessoa().getPessApelido());
        
                                                                } else if (se.getSalaeJuri1() != null) {
                                                                    j1 = encryptUtils.decodeString(se.getSalaeJuri1());
                                                                }
        
                                                                if (se.getJuri2() != null) {
                                                                    j2 = encryptUtils.decodeString(se.getJuri2().getPessoa().getPessNome()) + " " + encryptUtils.decodeString(se.getJuri2().getPessoa().getPessApelido());
        
                                                                } else if (se.getSalaeJuri2() != null) {
                                                                    j2 = encryptUtils.decodeString(se.getSalaeJuri2());
                                                                }
                                                    -->
                                                    <tr>
                                                        <td><!--=dis--></td>
