            ...
            <ul class="nav navbar-nav element-active-orange-400">
              <li class="active">
                <a
                  ...
                  ><i class="icon-reading position-left"></i> Criação de Júris
                  Exames (12ª Classe)</a
                >
              </li>
            </ul>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <form
              ...
              action="MTJDbGFzc2VTZXJ2bGV0I0RDSQ==?YWNjYW8janVyaXM="
            >
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    <input
                      type="text"
                      class="form-control"
                      placeholder="Nº máximo de alunos ..."
                      name="numAlunos"
                      required=""
                    />
                  </div>
              ...
              <div class="panel-body">
                <p>
                  <a
                    href="#"
                    target="_blank"
                    class="btn bg-slate-800 btn-labeled btn-lg text-bold text-uppercase"
                  >
                ...
                <table class="table datatable-responsive" width="100%">
                  ...
                  <tbody>
                    ...
                    String d1 =
                    sdf.format(se.getSalaeData().toGregorianCalendar().getTime());
                    String sa =
                    encryptUtils.decodeString(se.getSala().getSalaDescricao());
                    int num = se.getSalaeMaxAlunos(); String j1 =
                    encryptUtils.decodeString(se.getJuri1().getPessoa().getPessNome())+"
                    "+encryptUtils.decodeString(se.getJuri1().getPessoa().getPessApelido());
                    String j2 =
