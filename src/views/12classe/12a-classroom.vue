      ...
      <div class="content-wrapper">
            ...
            <ul class="nav navbar-nav element-active-orange-400">
              <li class="active">
                <a
                  ...
                  ><i class="icon-collaboration position-left"></i> Lista de
                  Júris</a
                >
              </li>
            </ul>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <form
              ...
              action="MTJDbGFzc2VTZXJ2bGV0I0RDSQ==?YWNjYW8jdHVybWFz"
            >
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <% String act4 =
            encryptUtils.encodeString("accao#filtrar-salaExame&to=12a-classroom");
            %>
          ...
          <div class="col-md-5">
            ...
            <div class="row">
              ...
              <div class="panel panel-flat">
                ...
                <% int total = homens + mulheres; int perH = Math.round((homens
                * 100.0f) / total); int perM = Math.round((mulheres * 100.0f) /
                total); int difH = 100 - perH; int difM = 100 - perM; %>
                <div class="panel-body">
              ...
              <table class="table datatable-responsive">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><a href="#"><%=ref%></a></td>
                    <td><%=nom%></td>
                    <td class="text-bold text-slate text-right"><%=med%></td>
                  </tr>
