      ...
      <div class="content-wrapper">
            ...
            <ul class="nav navbar-nav element-active-orange-400">
              <li class="active">
                <a
                  ...
                  ><i class="icon-exclamation position-left"></i> Marcação de
                  Presenças/Fraudes</a
                >
              </li>
            </ul>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <form
              ...
              action="MTJDbGFzc2VTZXJ2bGV0I0RDSQ==?YWNjYW8jcHJlc2VuY2Fz"
            >
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <% String act4 =
            encryptUtils.encodeString("accao#filtrar-salaExame&to=12a-presences");
            %>
              ...
              >
                <div class="panel-body">
                  <p>
                    ...
                    >
                      <b><i class="icon-checkmark-circle"></i></b> Confirmar
                      Presenças
                    </button>
                  </p>
                </div>
                ...
                <table class="table datatable-responsive">
                  <thead>
                    <tr>
                      ...
                      <th class="text-bold text-uppercase">Presente ?</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    String med = df.format(e.getExamMedia()); int idA =
                    e.getExamId(); String check = ""; String inc = "<i
                      class="icon-minus2 text-slate-800"
                    ></i
                    >"; if (e.isExamPresenca()) { check = "checked"; inc = "<i
                      class="icon-check text-success-600"
                    ></i
                    >"; } %>
                    <tr>
                      <td>
