<template>
  <v-container>
    ...
    <v-container>
      <v-row class="navbar navbar-default navbar-component navbar-xs">
          ...
          <ul class="nav navbar-nav element-active-slate-400">
            <li class="active">
              <a
                ...
                ><i class="icon-profile position-left"></i> Gestão de
                estudantes</a
              >
            </li>
          </ul>
      ...
      <v-row class="mt-4">
        <form
          ...
          action="QWx1bm9TZXJ2bGV0I0RDSQ==?<%=act%>"
        >
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <div class="row">
                          <div class="col-md-12">
                            <div
                              class="form-group has-feedback has-feedback-right"
                            >
                              <input
                                type="text"
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <input
                              ...
                              class="form-control mb-15 daterange-single"
                              name="dataValidade"
                            />
                          </div>
                  ...
                  <fieldset>
                    <legend class="text-semibold">
                      <i class="icon-user position-left"></i> Encarregado
                      Educação
                    </legend>
                        ...
                        <div class="row">
                          <div class="col-md-7">
                            ...
                            >
                              <input
                                type="text"
                                placeholder="Nome do Encarregado Educação"
                                class="form-control"
                                name="responsavel"
                                value="<%=resp%>"
                                required=""
                      ...
                      <div class="col-lg-9">
                        ...
                        <div class="row">
                          <div class="col-md-7">
                            <input
                              type="text"
                              placeholder="Local Trabalho do Pai"
                              class="form-control"
                              name="localPai"
                            />
                          </div>
                      ...
                      <div class="col-lg-9">
                        ...
                        <div class="row">
                          <div class="col-md-7">
                            <input
                              type="text"
                              placeholder="Local Trabalho da Mãe"
                              class="form-control"
                              name="localPai"
                            />
                          </div>
                ...
                <div class="col-md-6">
                  <fieldset>
                    <legend class="text-semibold">
                      <i class="icon-home5 position-left"></i> ENDEREÇO
                    </legend>
                  ...
                  <fieldset>
                    ...
                    <div class="form-group">
                      <label class="col-lg-7 control-label text-bold"
                        >Órfão/Vulnerável/Portador de Doença:</label
                      >
                      <div class="col-lg-4">
                        <div class="row">
                          <label class="radio-inline">
                  ...
                  <fieldset>
                    <legend class="text-semibold">
                      <i class="icon-book position-left"></i> Habilitações
                    </legend>
                      ...
                      <div class="col-lg-9">
                        <div class="row">
                          <div class="col-md-8">
                            <div class="mb-15">
                              <select
                                data-placeholder="Selecione a formação"
                                class="select"
                                required=""
                                name="nivel"
                              >
                      ...
                      <div class="col-lg-9">
                        <div class="row">
                          <div class="col-md-8">
                            <div class="mb-15">
                              <select
                                data-placeholder="Selecione a ocupação"
                                class="select"
                                required=""
                                name="ocupacao"
                              >
